  ...
  const doLaunch = async () => {
    try {
      ...
      const { submissionId } = await launch({
        ...
        workspace, config, selectedEntityType, selectedEntityNames, newSetName, useCallCache, deleteIntermediateOutputFiles, useReferenceDisks, userComment: _.trim(userComment),
        onProgress: stage => {
